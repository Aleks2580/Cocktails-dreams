...
module.exports = function Layout({ children, newUser, newUserEmail, newUserId }) {
          ...
          <><li className="nav-item">
                    <a className="nav-link active home" aria-current="page" href="/">Home</a>
                      ...
                      <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <li><a className="dropdown-item" href="/accountsaved">Saved cocktails</a></li>
                        <li><a className="dropdown-item" href="/recipes">Your recipes</a></li>
                        <li><a className="dropdown-item" href="/search">Search</a></li>
                        <li><a className="dropdown-item" href="/upload">Upload your cocktail</a></li>
                        <li>
                          <a className="dropdown-item" href="/logout">Logout</a>
                        </li>
                      </ul>
                      <li className="nav-item">
                        <a className="nav-link" href="/popular">Welcome, {newUser}</a>
                      </li>
                    </li></>
